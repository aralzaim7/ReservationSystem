...
public class MovieDBAdapter {
    ...
    private static final String DATABASE_MOVIETABLE = "Movie";
    private static final String DATABASE_USERTABLE = "user";
    private static final String DATABASE_RESTABLE = "Reservation";
    private static final int DATABASE_VERSION = 1;

    private static final String DATABASE_CREATE = "create table movie (id INTEGER PRIMARY KEY AUTOINCREMENT, "
    ...
    //BURAYA KADAR STANDARD DB BAGLANTISI, PROGRAMA GÖRE DEĞİŞECEK YERLERDİR.

    // Retrieves all the movies
    public Cursor getAllMovies()
    {
        Log.d("log","getall");
        //db.query yapıldıgında hazırlanmış select şeklinde çalışır
        // db.execSQL("select * from movie") yaparsak gene aynı mantıkda çalışır.
